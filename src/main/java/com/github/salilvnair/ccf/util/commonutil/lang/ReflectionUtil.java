...
public class ReflectionUtil {
    ...
    public static <T> T findFieldValueIfPresent(final Object obj, final String fieldName) {
        if(obj == null) {
            return null;
        }
        if(fieldName == null) {
    ...
    public static <T> T invokeMethodAndThrowException(Object obj, String methodName, Object... args) throws Exception {
        Object[] theArgs = ArrayUtils.nullToEmpty(args);
        final Class<?>[] parameterTypes = ClassUtils.toClass(theArgs);
        return invokeMethodAndThrowException(theArgs, parameterTypes, obj, methodName);
    }

    public static <T> T invokeMethodAndThrowException(final Object[] args,
                                                      final Class<?>[] parameterTypes, final Object obj, final String methodName) throws Exception {
        ...
        return invokeMethodAndThrowException(obj, method, args);
    }
